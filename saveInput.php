...
{
  file_put_contents("phpdebug/$netid"." Has Tried To Manipulate The Webpage",
  ...
  if (!file_exists("users/$folder/works")) {
      mkdir("users/$folder/works");
  }
  if (!file_exists("users/$folder/works_data")) {
      mkdir("users/$folder/works_data");
  }
  if (!file_exists("users/$folder/works_data/$name")) {
      mkdir("users/$folder/works_data/$name");
  }
  if (!file_exists("users/$folder/works_data/$name/$name"."_warnings")) {
      mkdir("users/$folder/works_data/$name/$name"."_warnings");
  }
  if (!file_exists("users/$folder/works_data/$name/$name"."_data"))
  {
      mkdir("users/$folder/works_data/$name/$name"."_data");
  }
  if (!file_exists("users/$folder/$folder"."_whitelist"))
  {
  ...
  file_put_contents("users/$folder/works/$name".".txt",$content);
